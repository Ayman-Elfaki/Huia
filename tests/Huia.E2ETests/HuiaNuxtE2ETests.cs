...
/// <summary>
/// Drives the first-party <c>huia-auth-nuxt</c> module end to end: its playground app against a real
...
/// </summary>
[Trait("Category", "E2E")]
[Collection("huia-auth-nuxt")]
public sealed class HuiaAuthNuxtE2ETests(HuiaAuthNuxtPlaygroundFixture fx)
{
