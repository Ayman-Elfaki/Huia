...
internal static class HuiaCookieConfiguration
{
    public static IServiceCollection AddHuiaCookieHardening(this IServiceCollection services, bool requireSecure)
    {
        ...
        {
            options.Cookie.Name = HuiaOpenIdConstants.Cookies.Authentication;
        ...
        {
            options.Cookie.Name = HuiaOpenIdConstants.Cookies.TwoFactorUser;
            options.Cookie.HttpOnly = true;
            options.Cookie.SameSite = SameSiteMode.Lax;
            options.Cookie.SecurePolicy = securePolicy;
        ...
        {
            options.Cookie.Name = HuiaOpenIdConstants.Cookies.AntiForgery;
            options.Cookie.HttpOnly = true;
