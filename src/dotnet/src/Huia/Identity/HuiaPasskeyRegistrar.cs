...
/// <summary>The outcome of <see cref="HuiaPasskeyRegistrar{TUser}.RegisterAsync"/>.</summary>
...
public class HuiaPasskeyRegistrar<TUser>(
    HuiaSignInManager<TUser> signInManager,
    HuiaUserManager<TUser> userManager,
    ...
    where TUser : HuiaUser, new()
{
    ...
    public async Task<PasskeyRegistrationOutcome> RegisterAsync(TUser user, string credentialJson, string? name)
    {
