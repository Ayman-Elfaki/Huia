...
export const authOptions: AuthOptions = {
    ...
    callbacks: {
        async jwt({token, account, profile}) {
            ...
            // *User* object, which the default token below doesn't carry over) — copy the ones the UI and
            // `huiaEndSessionUrl` need onto the JWT so they survive as part of the session cookie.
            if (profile) {
